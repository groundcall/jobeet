...
class Category extends \Ibw\JobeetBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'more_jobs', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'active_jobs', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'jobs', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Category' . "\0" . 'affiliates');
        }
    ...
    public function setActiveJobs($active_jobs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActiveJobs', array($active_jobs));

        return parent::setActiveJobs($active_jobs);
    }
