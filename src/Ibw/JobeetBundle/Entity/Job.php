...
class Job {
    ...
    // For handling file uploads a virtual file is created
    public $file;
    ...
    /**
     * User to "slugify" URL be replacing non ASCII chars
     */
    ...
    //add for admin - to make template more readable
